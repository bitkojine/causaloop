import { Model, Msg, Effect, UpdateFn, Snapshot, TimeProvider, RandomProvider, MsgLogEntry } from './types.js';

export interface DispatcherOptions<M extends Model, G extends Msg, E extends Effect> {
    readonly model: M;
...
export function createDispatcher<M extends Model, G extends Msg, E extends Effect>(
    options: DispatcherOptions<M, G, E>
): Dispatcher<M, G> {
